...
Only requiring some minor changes is privat.cpp.
...
Changes to privat.cpp
----------------------
privat.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
