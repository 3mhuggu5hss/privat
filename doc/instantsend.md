...
This mechanism has been integrated into Bitcore-Node-Privat which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/privatpay/insight-api-privat#web-socket-api](https://github.com/privatpay/insight-api-privat#web-socket-api) 
* API: [https://github.com/privatpay/insight-api-privat#instantsend-transactions](https://github.com/privatpay/insight-api-privat#instantsend-transactions) 
...
By default, the Privat Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Privat Core daemon:
