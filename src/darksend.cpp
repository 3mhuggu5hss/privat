...
{
    if(fLiteMode) return; // ignore all Privat related functionality
...
/*
    ...
    allow endless transaction that would bloat Privat and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("privat-privatesend");
