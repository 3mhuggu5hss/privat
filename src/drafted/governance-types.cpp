...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PrivatNetwork") type = PrivatNetwork;
    if(strType == "PrivatNetworkVariable") type = PrivatNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PrivatNetwork) s = "PrivatNetwork";
    if(type == PrivatNetworkVariable) s = "PrivatNetworkVariable";
