 ...
 *
 *   // network
 *   CPrivatNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.privat.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPrivatNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PrivatNetwork
// //   -- signature requirements : Key1(User)
// class CPrivatNetworkVariable : public CGovernanceObject
// {
// private:
