    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Privat Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Privat Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  privat-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Privat in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PRIVAT, 0.1 PRIVAT, 1 PRIVAT and 10 PRIVAT -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://privatpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://privatpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Privat Core is shutting down...") + "<br /><br />" +
