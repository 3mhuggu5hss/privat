    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PRIVAT-light"), QVariant("light"));
    ui->theme->addItem(QString("PRIVAT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PRIVAT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PRIVAT-traditional"), QVariant("trad"));
