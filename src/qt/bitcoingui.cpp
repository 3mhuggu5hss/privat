    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Privat Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Privat address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and privat: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Privat Core"), this);
    aboutAction->setStatusTip(tr("Show information about Privat Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Privat Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Privat addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Privat addresses"));
    ...
    openAction->setStatusTip(tr("Open a privat: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Privat Core help message to get a list with possible Privat Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Privat Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Privat network", "", count));
}
...
{
    QString strTitle = tr("Privat Core"); // default title
